...
// Builds the logo URL — explicit env var first, else the stable production domain's
// /logo.png (NOT process.env.VERCEL_URL — see resolveAppBaseUrl for why).
export function resolveLogoUrl() {
  return process.env.LOGO_URL || `${resolveAppBaseUrl()}/logo.png`;
}
