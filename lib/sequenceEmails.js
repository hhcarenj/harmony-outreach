...
// Resolves the deployed URL the same way the logo URL does elsewhere in this app.
function resolveBrochureUrl() {
  const appUrl = process.env.NEXT_PUBLIC_APP_URL || process.env.VERCEL_URL;
  const base = appUrl ? `https://${appUrl.replace(/^https?:\/\//, "")}` : "https://harmony-outreach.vercel.app";
